...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    while unvisited_corners:
        ...
        #distances = [(chebyshev_distance(current_position, corner), corner) for corner in unvisited_corners]  #using the chebyshev distance
    ...
    return heuristic
    #returneaza distanta manhattan de la pacman la cea mai apropiata mancare
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for food in foodGrid.asList():
        ...
        if dist > maxDist:
            maxDist = dist
    return maxDist
    #returneaza distanta maxima de la pacman la mancare
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        #face bfs de la pacman la mancare
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state: Tuple[int, int]):
        ...
        #verifica daca mancarea e la pozitia respectiva
